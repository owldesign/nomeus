...
class AvailableCommand extends Command
{
    ...
    protected $description = 'Service types nomeus can run, their brew formulae and default ports';
    ...
    public function handle(DriverRegistry $drivers, BrewBridge $brew): int
    {
        ...
        $this->line('<fg=gray>create one: nomeus services:create <type> [version] [--name=] [--port=]</>');
